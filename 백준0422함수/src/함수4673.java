	...
	public static void main(String[] args) {
		...
		selfNumArr[0] = true;
			...
			for(int j=1; j<=cycle; j++) {
				if(j < 100)result = j + j/10 + j%10;
				if(j < 1000)result = j + j/100 + (j/10)%10 + j%10;
				if(j < 10000)result = j + j/1000 + (j/100)%10 + (j/10)%10 + j%10;
				if(result > cycle) continue;
