...
public class Ex06 {
	...
	public static void main(String[] args) {
		...
		/*
		 * 보안에 걸린다. WebElement userid = driver.findElement(By.id("id"));
		 * userid.sendKeys("userid"); WebElement password =
		 * driver.findElement(By.id("pw")); password.sendKeys("password");
		 */
		...
		// ========================================================================================================
		/*
		 * // 5. 웹드라이버 닫기 driver.close();
		 * 
		 * // 6. 5초 후 웹드라이버 종료 try { Thread.sleep(5000); } catch (InterruptedException
		 * e) { e.printStackTrace(); } finally { // 웹드라이버 종료 driver.quit(); }
		 */
	}
}
