...
<style type="text/css">
	.mainContent {
		width: 80%; margin: auto; border: none;
	}
	.title{
...
<body>
	<div class="mainContent">
		<div class="title">허접한 방명록 Ver 0.009</div>
		<div class="pageInfo"><%=pv.getPageInfo() %></div>
		<%-- 글목록 --%>
		<%
		...
		<div class="pageList"><%=pv.getPageList() %></div>
		
		<%-- 글쓰기 버튼을 달자 --%>
		<div class="pageInfo">
		<input type="button" value="새 글쓰기" class="btn btn-outline-success btn-sm" 
		required="required" 
