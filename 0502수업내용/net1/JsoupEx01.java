...
public class JsoupEx01 {
	public static void main(String[] args) {
		try {
			...
			System.out.print("음력을 보고싶은 년월을 입력하시오");
			int year = sc.nextInt();
			int month = sc.nextInt();
			
			Document doc = Jsoup.connect("https://astro.kasi.re.kr/life/pageView/5" + String.format("?search_year=%04d&search_month=%02d", year,month)).get();
