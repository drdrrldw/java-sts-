...
public class StreamEx13 {
	public static void main(String[] args) {
		...
		Map<Employee.Gender, String> map2 = Employee.persons().stream().collect(Collectors.toMap(Employee::getGender,
				Employee::getName, (oldValue, newValue) -> String.join(",", oldValue, newValue)));
		...
		Map<Employee.Gender, Employee> map4 = Employee.persons().stream().collect(Collectors.toMap(Employee::getGender,
				Function.identity(),
